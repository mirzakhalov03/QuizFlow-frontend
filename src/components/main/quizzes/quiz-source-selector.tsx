  ...
  return (
    <div className="grid gap-4 pb-4 sm:grid-cols-2 sm:pb-6">
      ...
      <button
        ...
        disabled={!hasNotion}
        className="border-border bg-card/50 hover:border-primary/50 hover:bg-primary/5 group relative rounded-xl border-2 p-6 text-left transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-40"
      >
        {!hasNotion && (
