    ...
    <>
      <section className="container mx-auto grid items-center gap-10 px-4 py-12 sm:py-16 lg:grid-cols-2 lg:gap-12 lg:py-20">
        ...
        <div className="relative">
          <div className="from-background to-muted/40 border-border overflow- relative rounded-3xl border bg-linear-to-br p-4 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.45)] sm:p-6">
